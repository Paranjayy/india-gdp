...
const STATE_DATA: Record<string, StateComparison> = {
  ...
  JK: {
    ...
    gsdp: 28,
    flag: "🏔️",
    equivalentCountry: "Cyprus",
    equivalentCountryFlag: "🇨🇾",
    equivalentCountryGDP: 30,
    description: "Blessed with tourism, handicrafts, and agro-industries, Jammu & Kashmir's sub-national economy stands at ~$28B, comparable to the Mediterranean island nation of Cyprus (~$30B).",
  },
  HP: {
    code: "HP",
    ...
    gsdp: 25,
    flag: "🍏",
    equivalentCountry: "Iceland",
    equivalentCountryFlag: "🇮🇸",
    equivalentCountryGDP: 30,
    description: "Himachal Pradesh is a mountainous state famous for tourism, hydro-power, and horticulture. Its economy of ~$25B is close to Iceland (~$30B) and matches Bosnia and Herzegovina.",
  },
  UK: {
    code: "UK",
    name: "Uttarakhand",
    gsdp: 40,
    flag: "⛰️",
    equivalentCountry: "Bolivia",
    equivalentCountryFlag: "🇧🇴",
    equivalentCountryGDP: 45,
    description: "A center for pilgrimage tourism, organic farming, and manufacturing industries, Uttarakhand's GSDP of ~$40B stands neck-and-neck with Bolivia (~$45B).",
  },
  DL: {
    code: "DL",
    name: "Delhi",
    gsdp: 135,
    flag: "🏛️",
    equivalentCountry: "Kuwait",
    equivalentCountryFlag: "🇰🇼",
    equivalentCountryGDP: 140,
    description: "As India's capital territory and a service hub, Delhi's GSDP of ~$135B is on par with major oil-exporter Kuwait (~$140B) and exceeds Kenya's national economy.",
  },
  JH: {
    code: "JH",
    name: "Jharkhand",
    gsdp: 55,
    flag: "🏭",
    equivalentCountry: "Slovenia",
    equivalentCountryFlag: "🇸🇮",
    equivalentCountryGDP: 70,
    description: "Rich in mineral resources like coal, iron ore, and copper, Jharkhand's industrial output contributes to a ~$55B GSDP, comparable to Slovenia (~$70B).",
  },
  CG: {
    code: "CG",
    name: "Chhattisgarh",
    gsdp: 60,
    flag: "🌾",
    equivalentCountry: "Belarus",
    equivalentCountryFlag: "🇧🇾",
    equivalentCountryGDP: 70,
    description: "A major source of electricity and steel for India. Chhattisgarh's resource-driven GSDP of ~$60B closely matches Eastern European country Belarus (~$70B).",
  },
  OR: {
    code: "OR",
    name: "Odisha",
    ...
    equivalentCountryFlag: "🇴🇲",
    equivalentCountryGDP: 110,
    description: "With a vast coastline, mineral wealth, and growing industrial hubs, Odisha's GSDP of ~$105B matches the GDP of oil-producing nation Oman (~$110B).",
  },
  NE: {
    code: "NE",
    name: "North East (Assam)",
    gsdp: 75,
    flag: "🌱",
    equivalentCountry: "Uruguay",
    equivalentCountryFlag: "🇺🇾",
    equivalentCountryGDP: 75,
    description: "Famous for tea gardens, oil refineries, and biodiversity, the North East region (represented by Assam's hub) economy reaches ~$75B, mirroring South American nation Uruguay (~$75B).",
  }
};
...
const STATE_TILES: Tile[] = [
  { code: "JK", name: "Jammu & Kashmir", r: 0, c: 2, hasData: true },
  { code: "PB", name: "Punjab", r: 1, c: 1, hasData: true },
  { code: "HP", name: "Himachal Pradesh", r: 1, c: 2, hasData: true },
  { code: "UK", name: "Uttarakhand", r: 1, c: 3, hasData: true },
  { code: "RJ", name: "Rajasthan", r: 2, c: 0, hasData: true },
  { code: "HR", name: "Haryana", r: 2, c: 1, hasData: true },
  { code: "DL", name: "Delhi", r: 2, c: 2, hasData: true },
  ...
  { code: "JH", name: "Jharkhand", r: 3, c: 3, hasData: true },
  { code: "WB", name: "West Bengal", r: 3, c: 4, hasData: true },
  { code: "NE", name: "North East", r: 3, c: 5, hasData: true },
  { code: "MH", name: "Maharashtra", r: 4, c: 1, hasData: true },
  { code: "CG", name: "Chhattisgarh", r: 4, c: 2, hasData: true },
  { code: "OR", name: "Odisha", r: 4, c: 3, hasData: true },
