              ...
              {comparisonCountries.map((c) => {
                ...
                return (
                  <div key={c.code} className="flex items-center gap-3">
                    <div className="w-28 text-[11px] text-muted shrink-0 flex items-center gap-1.5">
                      <span>{c.flag}</span>
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-[11px] text-muted font-mono">GDP: {formatGDP(c.gdp)}</span>
                </div>
                <div className="text-[12px] text-muted leading-relaxed">
                  It takes <strong className="text-ink font-semibold">{numMusks} Elon Musks</strong> to equal the entire annual production of {c.name}.
                </div>
              </div>
            );
          })}
